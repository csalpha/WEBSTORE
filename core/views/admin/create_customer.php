	...
	<div class="container-fluid">
		...
		<!-- ===================================================================================================== -->
			<div class="row mt-3">
				...
				<!-- ===================================================================================================== -->
					<div class="col-md-10">
						<h3 class="text-center">Criar Novo Cliente</h3>
						<!-- form -->
						<!-- ===================================================================================================== -->				
							<form action="?a=create_customer" method="post">
								...
								<!-- ===================================================================================================== -->					
									<div class="my-4">
										<input action="?a=create_customer" type="submit" value="Criar Cliente" class="mb-3 btn btn-black text-uppercase filter-btn m-2">
									</div>	
								<!-- ===================================================================================================== -->					
