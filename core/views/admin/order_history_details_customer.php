                ...
                <!-- ===================================================================================================== -->                            
                    <div class="col-md-10">
                        <div class="col text-center">
                            ...
                            <a href="?a=change_password_customer&c=<?= Store::aes_encrypt($_SESSION['customer_temp']) ?>" class="mb-3 btn btn-black text-uppercase filter-btn m-2 m-1"><i class="fas fa-key"></i> Alterar a password</a>
                        ...
                        <!-- ===================================================================================================== -->                                
                            <div class="row">
                                ...
                                <!-- ===================================================================================================== -->                                
                                    <div class="col">
                                        <h4>DETALHE ENCOMENDA</h4><small><?= $data_order->order_code ?></small>
                                    </div>
                                <!-- ===================================================================================================== --> 
                                ...
                                <!-- ===================================================================================================== -->                                
                                    <div class="col text-end">
                                        <div class="mb-3 btn btn-black text-uppercase filter-btn m-2" onclick="apresentarModal()"><?= $data_order->status?></div>
                                        <?php if($data_order->status == 'PROCESSING'):?>                       
                                        <div class="m1">
                                            <a href="?a=generate_pdf_order&e=<?= core\classes\Store::aes_encrypt($data_order->id_order)?>" class="mb-3 btn btn-black text-uppercase filter-btn m-2">Ver PDF</a>
                                            <a href="?a=send_pdf_order&e=<?= core\classes\Store::aes_encrypt($data_order->id_order)?>" class="mb-3 btn btn-black text-uppercase filter-btn m-2">Enviar PDF</a>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                <!-- ===================================================================================================== -->                                
                        ...
                        <!-- ===================================================================================================== -->                        
                            <div class="row">
                                ...
                                <!-- ===================================================================================================== -->                                
                                    <div class="col">
                                        <p>Nome customer:<br><strong><?= $customer ?></strong></p>
                                        <p>Email:<br><strong><?= $data_order->email ?></strong></p>
                                        <p>telephone:<br><strong><?= $data_order->telephone ?></strong></p>
                                    </div>
                                <!-- ===================================================================================================== -->                                
                                ...
                                <!-- ===================================================================================================== -->
                                    <div class="col">
                                        <p>Data order:<br><strong><?= $data_order->order_date ?></strong></p>
                                        <p>address:<br><strong><?= $data_order->address ?></strong></p>
                                        <p>city:<br><strong><?= $data_order->city ?></strong></p>
                                    </div>
                                <!-- ===================================================================================================== -->                                
                            </div>
                        <!-- ===================================================================================================== -->                        
                                ...
                                <div class="modal-body">
                                    <div class="text-center">
                                        <?php
                                            ...
                                            <?php if($data_order->status == $estado):?>
                                                <p><?= $estado ?></p>
                                            <?php else:?>
                                                <p><a href="?a=order_change_status&e=<?= core\classes\Store::aes_encrypt($data_order->id_order) ?>&s=<?= $estado ?>" class="nav-it"><?= $estado ?></a></p>
                                            <?php endif;?>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
